...
```bash
npx -y @smithery/cli@latest install nanobanana-mcp --client <CLIENT_NAME>
```
...
```bash
npx -y @smithery/cli@latest install nanobanana-mcp --client cursor
```
...
```sh
claude mcp add nanobanana -- npx -y nanobanana-mcp
```
